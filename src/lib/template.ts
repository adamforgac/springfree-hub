...
import { PRODUCT_SKUS, PRODUCT_SLUGS } from './product_dictionary';
...
<td width="80" align="center" valign="top">
<!--[if mso]><table border="0" cellpadding="0" cellspacing="0"><tr><td width="32" height="32" bgcolor="#e2e8f0" style="border-radius:16px;text-align:center;"><span style="font-family:Arial,sans-serif;font-size:14px;color:#94a3b8;line-height:32px;">2</span></td></tr></table><![endif]-->
<!--[if !mso]><!--><div style="width:32px;height:32px;background-color:#e2e8f0;border-radius:50%;text-align:center;line-height:32px;margin:0 auto;"><span style="font-family:Arial,sans-serif;font-size:14px;color:#94a3b8;">2</span></div><!--<![endif]-->
<div style="padding-top:8px;font-family:Arial,sans-serif;font-size:12px;color:#94a3b8;text-align:center;">${t.timelineSent}</div>
</td>
<td valign="top" style="padding-top:15px;">
...
<div style="padding-top:8px;font-family:Arial,sans-serif;font-size:12px;color:#94a3b8;text-align:center;">${t.timelineDelivered}</div>
</td>
</tr>
</table>
</td>
